...
public class Gui extends Application {
    ...
    private void initContent(GridPane pane) {
        ...
        pane.add(txfName1, 0, 2);
        pane.add(txfName2, 1, 2);

        pane.add(txfName3, 0, 0, 2, 2);

        Button combine = new Button("Split");
        pane.add(combine, 0, 4);
        combine.setOnAction(event -> splitName());
    ...
    private void splitName() {
        String lol = txfName3.getText();
        String[] lolloren = lol.split(" ");
        txfName1.setText(lolloren[0]);
        txfName2.setText(lolloren[1]);
